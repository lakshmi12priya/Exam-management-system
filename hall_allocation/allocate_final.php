...
<?php
    ...
    $dets_query="Select ex_date,t.ex_session,t.course_code,course_name
           ...
           where t.course_code=u_course.course_code and t.ex_session='$_SESSION[chosen_session]' and u_course.dept_id='$_SESSION[dept_id]'";
    ...
    while(($details=mysqli_fetch_assoc($dets_run)))
    {
        ...
        $num_of_students=$count['num'];
        echo "<td>$num_of_students</td>";
     
        // $quotient1=71/25;
        $num_rooms=$num_of_students/25; //no.of rooms
        // echo "<td> $num_rooms</td>";
        $remainder=$num_of_students%25;
        ...
        if($num_rooms<=1)
        {
            ...
            $invigilator_idx = 0;
            $no_of_students='$num_of_students';
            ...
            echo "<td>";
                ...
                // mysqli_query($conn, "INSERT INTO exam_rooms (course_code, ex_date, ex_session, 
                //                 room_num, invigilator_id,no_of_students) VALUES ('$course_code', '$details[ex_date]' 
                //                 , '$_SESSION[chosen_session]', '$room_num', '$invigilator_id','$no_of_students')");
